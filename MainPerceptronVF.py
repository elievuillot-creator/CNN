...
# Commentaire : notre code génère des poids initiaux aléatores pour l'entrainement. Afin de pouvoir comparer
# nos résutats dans nos tests, les poids initiaux du premier entrainement ont été conserver pour toute la série de test.
# cela peut expliquer que les résultats diffèrent légèrement pour des mêmes paramètres sur différents entrainemnt
# sont lancer sans conserver les poids initiaux. La fonction save_initial_weight permet de sauvegarder les poids initiaux, et
# load_initial_weight, de les charger.
